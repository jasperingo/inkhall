...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../css/main.css?xx" />

		<link rel="stylesheet" type="text/css" href="../css/hall-member-request-item.css?a" />
			...
			<section class="page-head">
				...
				<div class="main-row">
					...
					<ul class="tab">
						...
						<li>
							<a href="hall-members-requests.php" class="active">Requests</a>
						</li>
						<li>
			...
			<section>
				...
				<div class="main-row">
					...
					<ul class="list-halved">
						<?php include "hall-member-request-item.php"; ?>
						<?php include "hall-member-request-item.php"; ?>
						<?php include "hall-member-request-item.php"; ?>
						<?php include "hall-member-request-item.php"; ?>
						<?php include "hall-member-request-item.php"; ?>
