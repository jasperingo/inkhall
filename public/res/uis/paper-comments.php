...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="../css/main.css?nk" />

		<link rel="stylesheet" type="text/css" href="../css/comment-item.css?t" />
		...
		<main>
			...
			<section class="page-head">
				...
				<div class="main-row">
					...
					<h1>
						<a href="paper-home.php">AI development with java Hybrid framework</a>
					</h1>
